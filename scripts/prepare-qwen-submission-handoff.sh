...
cp docs/qwen-presentation.html "$BUNDLE_DIR/docs/qwen-presentation.html"
cp docs/.nojekyll "$BUNDLE_DIR/docs/.nojekyll"
mkdir -p "$BUNDLE_DIR/docs/assets"
cp docs/assets/biddesk-autopilot-qwen-demo-preupload.mp4 "$BUNDLE_DIR/docs/assets/biddesk-autopilot-qwen-demo-preupload.mp4"
...
cp submission/qwen-presentation-deck.md "$BUNDLE_DIR/qwen-presentation-deck.md"
cp submission/BidDesk-Autopilot-Qwen-presentation.pptx "$BUNDLE_DIR/BidDesk-Autopilot-Qwen-presentation.pptx"
...
cp submission/qwen-public-pages-video-fallback.md "$BUNDLE_DIR/qwen-public-pages-video-fallback.md"
