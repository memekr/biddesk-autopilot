...
- `submission/qwen-final-captcha-bridge-paste-sheet.md` is the single paste-ready sheet to keep open after manual Devpost CAPTCHA completion, with current 8,228-participant source state and every final field value/URL.
