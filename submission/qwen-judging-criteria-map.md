...
| Presentation & Documentation | 15% | README, architecture diagram, sub-3-minute demo script, presentation deck outline, ready checklist, deployment proof gate | `README.md`, `submission/qwen-presentation-deck-outline.md`, `submission/qwen-video-duration-arbitration.md`, `submission/qwen-ready-checklist.md` | Final deck/video URLs must be public and owned by the entrant before Devpost final submit. |
